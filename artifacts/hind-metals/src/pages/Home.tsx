          ...
          <div className="max-w-3xl">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/20 border border-primary/30 text-primary mb-6">
                ...
                <span className="text-xs font-bold tracking-widest uppercase">ISO-Certified Global Metals Exporter</span>
              </div>
              <h1 className="text-5xl md:text-7xl font-heading font-bold text-white uppercase tracking-tight leading-[1.1] mb-6">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-orange-400">Export Ready.</span>
              </h1>
              <p className="text-lg md:text-xl text-gray-300 mb-10 max-w-2xl leading-relaxed">
                Premium ferrous and non-ferrous metals sourced from certified Indian mills and supplied to manufacturers, EPC contractors, and distributors worldwide. Precision. Reliability. Global reach.
              </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-white/20">
            {[
              ...
              { label: "Products in Catalog", value: "500+" },
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            >
              <h2 className="text-primary font-bold tracking-widest uppercase mb-3 text-sm">Your Global Supply Partner</h2>
              <h3 className="text-4xl md:text-5xl font-heading font-bold text-charcoal mb-6 uppercase tracking-tight">
                Forged in India.<br />Trusted Worldwide.
              </h3>
              <p className="text-gray-600 mb-6 text-lg leading-relaxed">
                Hind Metals is a certified metals exporter supplying OEM manufacturers, EPC contractors, infrastructure developers, and industrial distributors across Asia, the Middle East, Europe, and beyond.
              </p>
              <p className="text-gray-600 mb-8 leading-relaxed">
                Rooted in Rajasthan — India's leading industrial manufacturing belt — we combine deep mill relationships with rigorous quality control and international export logistics to deliver materials that meet global engineering standards every time.
              </p>
              <Link href="/about">
      ...
      <section className="py-24 bg-light-steel">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-primary font-bold tracking-widest uppercase mb-3 text-sm">Inventory</h2>
            <h3 className="text-4xl font-heading font-bold text-charcoal uppercase tracking-tight">Industrial Grade Materials</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { 
                name: "Steel & Iron", 
                desc: "MS plates, angles, channels, structural steel, and TMT bars.",
                img: productsSteelImg
              },
              { 
                name: "Copper & Brass", 
                desc: "High-conductivity sheets, rods, pipes, and custom fittings.",
                img: productsCopperImg
              },
              { 
                name: "Aluminum", 
                desc: "Lightweight extrusions, polished sheets, and industrial pipes.",
      ...
      <section className="py-24 bg-charcoal text-white relative">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-primary font-bold tracking-widest uppercase mb-3 text-sm">End-to-End Capability</h2>
              <h3 className="text-4xl md:text-5xl font-heading font-bold uppercase tracking-tight mb-8">Built for Global Trade</h3>
              
              <div className="space-y-8">
                {[
                  { title: "Precision Processing", desc: "Cut-to-size, custom dimensions, and mill-finish processing delivered to exact engineering specifications." },
                  { title: "International Logistics", desc: "Full export documentation, freight forwarding, and door-to-port delivery coordinated with global shipping partners." },
                  { title: "Certified Quality", desc: "Mill Test Certificates, third-party inspection reports, and compliance with ASTM, EN, IS, and JIS standards on every shipment." }
                ].map((service, i) => (
                  <motion.div 
                    key={service.title}
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gray-50 border border-gray-200 p-10 md:p-16 max-w-4xl mx-auto text-center relative overflow-hidden">
            ...
            <h3 className="text-3xl md:text-4xl font-heading font-bold uppercase text-charcoal mb-4">Ready to source from a certified Indian exporter?</h3>
            <p className="text-gray-600 mb-8 text-lg">Send us your technical specifications, grades, and quantities. Our export team responds within 24 hours with pricing, lead times, and documentation details.</p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/contact">
                <Button size="lg" className="w-full sm:w-auto">Request an Export Quote</Button>
              </Link>
              <a href="tel:+919414058143">
                <Button size="lg" variant="outline" className="w-full sm:w-auto border-charcoal text-charcoal">Speak to Our Export Team</Button>
              </a>
            </div>
          </div>
        </div>
