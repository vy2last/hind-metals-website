...
const categories = [
  ...
  },
  {
    ...
    desc: "High-pressure and low-pressure die casting in zinc (Zamak), magnesium, and copper-alloy metals for high-volume, complex-geometry components. Net-shape accuracy, thin-wall capability, and excellent surface finish — minimising secondary machining costs.",
    items: [
      "Zinc / Zamak Die Castings",
      "Magnesium Alloy Castings",
      "Copper-Alloy Pressure Castings",
      "Thin-Wall & Complex Geometry Parts",
      "High-Volume OEM Components",
      "Custom Grade to Buyer Specification",
    ],
    img: productsSteelImg,
  },
  {
    id: "sand-casting",
    name: "Traditional Sand Casting",
    desc: "Green sand and resin-bonded sand casting for grey iron, ductile iron, carbon steel, and alloy steel components. Ideal for low-to-medium volumes, large-section parts, and prototypes where tooling economy and alloy flexibility are priorities.",
    items: [
      "Green Sand & Resin Sand Process",
      "Grey Iron & Ductile Iron Castings",
      "Carbon & Alloy Steel Castings",
      "Large Section / Heavy Components",
      "Prototype & Short-Run Castings",
      "Custom Alloys to Buyer Spec",
    ],
    img: productsCopperImg,
  },
  {
    id: "machining",
    name: "Advanced Machining — VMC / HMC / CNC",
    desc: "In-house precision machining on Vertical Machining Centres (VMC), Horizontal Machining Centres (HMC), and CNC turning centres. Post-casting machining to tight dimensional tolerances — delivering fully finished, assembly-ready components.",
    items: [
      "CNC Turning & Milling",
      "VMC — 3-Axis & 4-Axis Vertical Machining",
  ...
  {
    id: "powder-coating",
    name: "Powder Coating & Surface Finishing",
    desc: "In-house powder coating line for cast iron, aluminium die cast, and steel components. Electrostatic powder application with curing oven — providing durable, corrosion-resistant, and aesthetically consistent surface finishes to RAL colour standards.",
    items: [
      "Electrostatic Powder Coating",
      "RAL Standard Colour Matching",
      "Corrosion-Resistant Finish",
      "Shot Blasting & Pre-Treatment",
      "Epoxy & Polyester Powder Options",
      "Custom Texture & Gloss Levels",
    ],
    img: productsSteelImg,
  },
  {
